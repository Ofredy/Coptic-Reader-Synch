"""
Test: psalm_27_english alignment

Run with:
    pytest test/psalm_27_english/test_psalm_27_english.py -v
or:
    python test/psalm_27_english/test_psalm_27_english.py

NOTE: Anchor timestamps are initially set as estimates.
      After the first real Whisper run, update ANCHORS with values
      from alignment.json and tighten TOLERANCE if desired.
"""
import json
import sys
...
AUDIO   = HERE / "psalm_27.mp3"
REF     = HERE / "psalm_27.txt"
